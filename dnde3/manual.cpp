...
{Skill, Backstabbing, 0, "Добавляет дополнительный урон в процентах равный [навык*3] и шанс попадания в процентах равный [навыку], если атака делается из невидимого состояния. После такой атаки вы становитесь видимым."},
