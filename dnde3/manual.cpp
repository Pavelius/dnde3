...
BSDATA(manual) = {
	...
	{Skill, Alertness, 0, "Добавляет [++1%%] к шансу обнаружить ловушку за каждые 4 единицы.", skill_proc},
	...
	{Skill, Religion, 0, "Отображает шанс удачной молитвы божеству в час нужды. Расходует очки веры, которые пополняются при пожертвованиях в храмах.", skill_proc},
