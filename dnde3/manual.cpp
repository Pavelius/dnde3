...
{Skill, Climbing, 0, "При движении по горам делается тест и если он не пройден затраты времени на движения существенно увеличивается на 50%%. Такой тест делается для каждого героя в партии.", skill_proc},
