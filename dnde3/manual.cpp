...
{Skill, Athletics, 0, "Персонаж с этим навыком разносит двери в щепки. При повышении уровня имеется шанс повысить **ловкость** или **силу**. Также повышает скорость движения персонажа в локации."},
...
{Skill, Climbing, 0, "При движении по горам делается тест и если он не пройден затраты времени на движения существенно увеличивается на 50%%. Такой тест делается для каждого героя в партии."},
