...
BSDATA(manual) = {{NoVariant, Variant, "Мануал", "Содержит справочную информацию по правилам игры.", manual_list},
