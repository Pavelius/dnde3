...
{"Логово"},
{0, 0, temple},
{"Таверна \"%1 %2\"", "Вокруг стен стояли деревянный столы, на которых была выпивка. За столом сидели люди, пили и ели.", {}, {}, NoTileObject, Bartender},
{"Бараки", "Вокруг стен стояло множество стеллажей с оружием."},
{"Магистратура"},
...
{0, "Вокруг стен стояло множество стоек и шкафов на которых стояли бутылочки различных цветов.", shop_potions, shop_end, NoTileObject, Shopkeeper, {{80, Drinkable, 20}}},
