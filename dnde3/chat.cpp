...
{}};
static quest all_chat[] = {{1, {Opponent, Owner}, "Заходи. Смотри. Выбирай."},
{1, {Opponent, ShopWeaponAndArmor}, "Мечи самое сбалансированное оружие. Есть огромный выбор. Двуручный меч медленный, но наносит больше всего урона. Кинжал можно использовать во второй руке и он достаточно быстрый."},
{1, {Opponent, ShopFood}, "Хлеб гномов та еще пища - напоминает вкус земли. Но для настоящего гнома это тот еще деликатес! Любой гном его обажает, ведь на них он сказывается благосклонно."},
{1, {Opponent, ShopFood}, "Моя рекомендация - есть больше яблок. Чем больше ты их будешь есть, тем [сильнее] станешь."},
{1, {Opponent, ShopFood}, "Колбаса наиболее питательный продукт. Она укрепляет здоровье и повышает самочуствие. Еш больше колбасы и у тебя будет высокое [телосложение]."},
{1, {Opponent, ShopFood}, "Если где найдешь хлеб хоббитов, помни - этот продукт сделан из экологически чистого материала и очень хорошо усваивается организмом. Говорят, что те кто его едят много [хорошо выглядят] и имеют необычайный заряд бодрости."},
{1, {Opponent, HumanChild}, "Мама мне не разреает общаться с незнакомцами."},
{1, {Opponent, HumanChild}, "Как тебя зовут?"},
{1, {Opponent, HumanChild}, "Ты такой большой!"},
{1, {Opponent, HumanChild}, "Не хочу разговаривать. Ты страшный."},
{1, {Opponent, HumanGuard}, "Я за тобой слежу."},
{1, {Opponent, HumanGuard}, "Я есть закон."},
{1, {Opponent, HumanGuard}, "Что? Куда он побежал?"},
